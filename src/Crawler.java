...
public class Crawler {
    ...
    //percentage of people that would make the recipe again
    ...
    // add new cvs entry to reports.csv
    ...
    private boolean isLink(String href) {
        return href.contains("tasty.co/recipe") || href.contains("/topic") || href.contains("/article") || href.contains("/compilation");
    }
} //end Crawler
